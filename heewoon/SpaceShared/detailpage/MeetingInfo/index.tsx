...
import detailItem from '~/Screens/SpaceShared/detailpage';
...
function MeetingInfo ({route}) {
  ...
  return (
    ...
    <Container>
      ...
      <PlaceShotList
        images={[
          "http://api.randomuser.me/portraits/women/8.jpg",
          "http://api.randomuser.me/portraits/women/18.jpg",
          "http://api.randomuser.me/portraits/women/38.jpg",
        ]}
      />
      <Liked>
        <Liked2>
