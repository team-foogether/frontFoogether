...
const LocationPrivacy = ({navigation}: Props) => {
    return(
        <ScrollView>
            <Container>
                <LabelContainer>
                    <LabelTitle>위치기반서비스 이용약관</LabelTitle>
                    <LabelTop>안내문</LabelTop>
                    <LabelContent>푸게더는 회원님의 권익을 보호하고 회원님들의 위치정보 보호에 만전을 기하고자 관계법령의 규정을 반영하여 2020년 06월 20일부터 위치기반서비스 이용약관을 적용하고 있습니다.</LabelContent>
                    <Label>제 1조(목적)</Label>
