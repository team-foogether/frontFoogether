...
const PrivacyPolicy = ({navigation}: Props) => {
    return(
        <ScrollView>
            <Container>
                <LabelContainer>
                    <LabelTitle>개인정보처리방침</LabelTitle>
                    <LabelContent>Foogether(푸게더)주식회사 (이하 "회사" 또는 "푸게더"라 함)는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.</LabelContent>
                    <Label>1. 개인정보의 처리목적</Label>
